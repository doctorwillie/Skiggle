...
public class PenCharacterEn {
	...
	private void get4SegmentCharacterCandidates(PenCharacter pChar) {
		...
		SegmentBitSetEn sBitSet1 = SegmentBitSetEn.getSegmentBitSetForChar(strokeChar1);
		SegmentBitSetEn sBitSet2 = SegmentBitSetEn.getSegmentBitSetForChar(strokeChar2);
		SegmentBitSetEn sBitSet3 = SegmentBitSetEn.getSegmentBitSetForChar(strokeChar3);
		SegmentBitSetEn s4SegmentsBitSet = new SegmentBitSetEn();
		s4SegmentsBitSet.copy(SegmentBitSetEn.FOUR_SEGMENTS_BITSET);
